...
import { checkoutController, paymentVerification } from '../controllers/paymentController.js'
...
router.get('/yearlyWiseOrderCount', authMiddleware, isAdmin, getYearlyWiseOrderCount)
