  ...
  return (
    <div className="m-6">
      ...
      <div className="flex justify-center items-center -mt-6 mb-[16px]">
        <button className="flex rounded-full  py-3 px-7 border border-[#AD8A85] bg-white hover:text-redText hover:border-redText">
          <img
      ...
      <div>
        ...
        <h1 className="text-redText  text-2xl">$6.50</h1>
      </div>
    </div>
  );
}
